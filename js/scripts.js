...
function initHomeradar() {
  ...
  $(".smact").on("click", function (e) {
    ...
    $(this)
      .parents(".smpar")
      .find(".show-more-snopt-tooltip")
      .toggleClass("show-more-snopt-tooltip_vis");
  });
  ...
  function headerModalOpt() {
    ...
    $(".header-opt-modal-item h4").on("click", function () {
      ...
      $(this)
        .parents(".header-opt-modal-item")
        .find(".header-opt-modal-list")
        .toggleClass("vis_homd");
    });
  }
  headerModalOpt();
  ...
  function mobMenuInit() {
    ...
    if (ww < 1054) {
      ...
      $(".novis_header-mod .hopmc_init")
        .clone()
        .addClass("header-opt-modal-container_mob")
        .appendTo(".main-menu");
      $(".add-list_wrap a").removeClass("add-list");
      $(".add-list_wrap a")
        .clone()
        .addClass("add-list_mob")
        .appendTo(".main-menu");
      headerModalOpt();
      hideHeaderopt();
    } else {
  ...
  $(".fixed-column_menu-init").scrollToFixed({
    ...
    limit: function () {
      var a =
        ...
        $(".fixed-column_menu-init").outerHeight() -
        1;
      return a;
    },
  });
  $(".box-widget-fixed-init").scrollToFixed({
    ...
    limit: function () {
      var a =
        $(".limit-box").offset().top -
        $(".box-widget-fixed-init").outerHeight() -
        1;
      return a;
    },
  });
  ...
  if (
    ...
    $(".fixbar-action").scrollToFixed({
      ...
      limit: function () {
        var a =
          $(".limit-box").offset().top - $(".fixed-bar").outerHeight() - 50;
        return a;
      },
    });
