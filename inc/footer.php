                ...
                <div class="col-md-3">
                    <div class="footer-widget fl-wrap">
                        ...
                        <ul class="footer-list fl-wrap">
                            ...
                            <li><a href="blog.php">Our last News</a></li>
...
<div class="secondary-nav">
    <ul>
        <li><a href="dashboard-add-listing.php" class="tolt" data-microtip-position="left" data-tooltip="Sell Property"><i class="fal fa-truck-couch"></i> </a></li>
        <li><a href="listing.php" class="tolt" data-microtip-position="left" data-tooltip="Buy Property"> <i class="fal fa-shopping-bag"></i></a></li>
        <li><a href="compare.php" class="tolt" data-microtip-position="left" data-tooltip="Your Compare"><i class="fal fa-exchange"></i></a></li>
    </ul>
